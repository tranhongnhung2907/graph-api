...
<head>
  <meta charset="utf-8" />
  <title>Nuhula FB Script</title>
</head>
<body>
  <div id="fb-root"></div>
  <script>

    var app_id = '211010336096781';
    var app_scope = 'public_profile,email,user_likes,user_posts,publish_actions,user_photos,manage_pages,publish_pages,read_page_mailboxes,pages_show_list,pages_manage_cta,pages_manage_instant_articles,ads_management,ads_read';
    var app_uri = 'http://localhost/graph-api/nuhula';
  ...
  function statusChangeCallback(response) {
    ...
    if (response.status === 'connected') {
      ...
      // document.getElementById('user_submit4').setAttribute('value', new Date());
      console.log('test thôi ạ');
  ...
  function test() {
    ...
    FB.api('/1622767954401991/comments?access_token=EAACZC6awggg0BAMVQwrqzkkfVylgGRlW2od40PFc6DG3yRsMcu6o50Ge0c5CznZBuSNc9RsqmXfQs7lAJUsGtN0S8lvIRoMSnlSX1pzZCDfCaVrPs38gFfi8Ae0ZBIklQHXnrN0hKFiSqbBVRVdQhYCOZA4LefIGVN6601MZBdmgZDZD', 'post', {'message': body}, function(response) {
